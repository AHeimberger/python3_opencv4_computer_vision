...
found_rects, found_weights = hog.detectMultiScale(img, winStride=(4, 4), scale=1.02, groupThreshold=1.9)
...
for ri, r in enumerate(found_rects_filtered):
    ...
    cv2.putText(img, text, (x, y - 20), cv2.FONT_HERSHEY_SIMPLEX, 1, red, 2)
